...
const Form = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formType === "athlete") {
      ...
      axios
        .post("https://jkta-backend.onrender.com/register-user", formData, {
          headers: {
        ...
        .then((res) => {
          ...
          const options = {
            ...
            handler: function (response) {
              axios
                .post("https://jkta-backend.onrender.com/verify-payment", {
      ...
      axios
        .post("https://jkta-backend.onrender.com/register-coach", formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
        .then((res) => {
          ...
          const options = {
            ...
            handler: function (response) {
              axios
                .post("https://jkta-backend.onrender.com/verify-payment-coach", {
                  razorpay_order_id: response.razorpay_order_id,
                  razorpay_payment_id: response.razorpay_payment_id,
                  razorpay_signature: response.razorpay_signature,
        ...
        .catch((err) => {
          console.log(err);
          alert("Error in coach form submission or Razorpay order creation.");
        });
    }
  };

...
const Contact = () => {
  return (
    <div className="container mx-auto p-6 md:p-8 lg:p-12 bg-[#005377] text-white">
      <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-[#F1A208]">
        Contact Us
      </h2>

      {/* Phone Number and Call Button */}
      <div className="mb-6 md:mb-8 p-4 md:p-6 bg-[#052F5F] rounded-md flex flex-col md:flex-row items-center transition-transform transform hover:scale-105">
      ...
      {/* Address */}
      <div className="mb-6 md:mb-8 p-4 md:p-6 bg-[#052F5F] rounded-md transition-transform transform hover:scale-105">
      ...
      <div className="p-4 md:p-6 bg-[#052F5F] rounded-md transition-transform transform hover:scale-105">
        <h3 className="text-xl md:text-2xl font-semibold mb-4 text-[#F1A208]">
          Find Us Here
        </h3>
        <iframe
